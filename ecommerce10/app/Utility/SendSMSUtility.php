...
class SendSMSUtility
{
    ...
    {        
        ...
        elseif (OtpConfiguration::where('type', 'shadhinsms')->first()->value == 1) {
         $url = "https://sms.maria-bd.com/admin/index.php?route=api/sms/send&auth_key=jZlcZf3f1r7OYwY9qa5rgKq8Vn0CgHGbSy1DezenV&device_id=2&sim_id=3&data_type=Plain&user_id=1";
              $data = [
                "type" => "text",
                "mobile_no" => $to,
                "message" => $text,
